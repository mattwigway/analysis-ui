...
export default class SinglePointAnalysis extends Pure {
  ...
  componentDidMount () {
    const p = this.props
    if (!p.currentProject) p.setCurrentProject(p.projects[0]._id)
        ...
        <div className='ApplicationDock analysisMode'>
          ...
          <InnerDock>
            ...
            <div className='block'>
              ...
              <AdvancedSettings
                customProfileRequestJson={customProfileRequestJson}
                disabled={disableInputs}
                ...
                setCustomProfileRequestJson={setCustomProfileRequestJson}
              />
            </div>
          </InnerDock>
        </div>
