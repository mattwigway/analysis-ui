...
export default class AdvancedSettings extends Component {
  ...
  setBikeTrafficStress = (e: Event & {target: HTMLInputElement}) =>
      this.set({bikeTrafficStress: parseInt(e.target.value)}) // km/h to m/s
            ...
            <div className='row'>
              <div className='col-xs-4'>
                <InputNumber
                  disabled={disabled}
                  label='Bike LTS'
                  value={bikeTrafficStress}
                  min={1}
                  max={4}
                  step={1}
                  name='bikeTrafficStress'
                  onChange={this.setBikeTrafficStress}
                />
              </div>
              <div className='col-xs-4'>
                <InputNumber
